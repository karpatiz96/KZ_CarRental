...
namespace CarRental.Dal.SeedServices
{
    public class SeedService : ISeedService
    {
        ...
        {
            new VehicleModel(){ Id = 1, VehicleType = "Kia Picanto MCMN", VehicleUrl = "kia-picanto-3.png" ,NumberOfDoors = 3, NumberOfSeats = 4, AirConditioning = false, Automatic = false, PricePerDay = 10000, Active = true },
            new VehicleModel(){ Id = 2, VehicleType = "Kia Picanto MCMR", VehicleUrl = "kia-picanto-5.png" ,NumberOfDoors = 5, NumberOfSeats = 4, AirConditioning = true, Automatic = false, PricePerDay = 12000, Active = true },
            new VehicleModel(){ Id = 3, VehicleType = "Opel Corsa", VehicleUrl = "opel-corsa-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = false, PricePerDay = 12000, Active = true },
            new VehicleModel(){ Id = 4, VehicleType = "Citroen C3", VehicleUrl = "citroen-c3-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = false, PricePerDay = 13000, Active = true },
            new VehicleModel(){ Id = 5, VehicleType = "Citroen C4", VehicleUrl = "citroen-c4-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = false, PricePerDay = 14000, Active = true },
            new VehicleModel(){ Id = 6, VehicleType = "Toyota Auris Hybrid", VehicleUrl = "toyota-auris-hybrid-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = false, PricePerDay = 17000, Active = true },
            new VehicleModel(){ Id = 7, VehicleType = "Ford Focus", VehicleUrl = "ford-focus-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = false, PricePerDay = 16000, Active = true },
            new VehicleModel(){ Id = 8, VehicleType = "Mini Cooper Countrman", VehicleUrl = "mini-countryman-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = false, PricePerDay = 13000, Active = true },
            new VehicleModel(){ Id = 9, VehicleType = "BMW 116i", VehicleUrl = "bmw-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = true, PricePerDay = 19000, Active = true },
            new VehicleModel(){ Id = 10, VehicleType = "Ford Focus SW", VehicleUrl = "ford-focus-kombi-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = false, PricePerDay = 15000, Active = true },
            new VehicleModel(){ Id = 11, VehicleType = "Toyota Corolla Sedan", VehicleUrl = "toyota-corolla-4.png" ,NumberOfDoors = 4, NumberOfSeats = 5, AirConditioning = true, Automatic = false, PricePerDay = 18000, Active = true },
            new VehicleModel(){ Id = 12, VehicleType = "Ford Mondeo", VehicleUrl = "ford-mondeo-4.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = true, PricePerDay = 16000, Active = true },
            new VehicleModel(){ Id = 13, VehicleType = "Skoda Octavia", VehicleUrl = "skoda-octavia-4.png" ,NumberOfDoors = 4, NumberOfSeats = 4, AirConditioning = true, Automatic = false, PricePerDay = 13000, Active = true },
            new VehicleModel(){ Id = 14, VehicleType = "Mercedes Benz B Class", VehicleUrl = "mb-b-klasse-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = true, PricePerDay = 14000, Active = true },
            new VehicleModel(){ Id = 15, VehicleType = "BMW 318d", VehicleUrl = "bmw-3er-4.png" ,NumberOfDoors = 4, NumberOfSeats = 5, AirConditioning = true, Automatic = false, PricePerDay = 18000, Active = true },
            new VehicleModel(){ Id = 16, VehicleType = "BMW X1", VehicleUrl = "bmw-x1-5.png" ,NumberOfDoors = 5, NumberOfSeats = 5, AirConditioning = true, Automatic = true, PricePerDay = 18000, Active = true },
            new VehicleModel(){ Id = 17, VehicleType = "BMW 520d", VehicleUrl = "bmw-5er-4.png" ,NumberOfDoors = 4, NumberOfSeats = 5, AirConditioning = true, Automatic = true, PricePerDay = 18000, Active = true },
            new VehicleModel(){ Id = 18, VehicleType = "Mercedes-Benz S-Class", VehicleUrl = "mb-s-klasse-4.png" ,NumberOfDoors = 4, NumberOfSeats = 5, AirConditioning = true, Automatic = true, PricePerDay = 20000, Active = true },
            new VehicleModel(){ Id = 19, VehicleType = "Renault Grand Scenic", VehicleUrl = "renault-grand-scenic-5.png" ,NumberOfDoors = 5, NumberOfSeats = 7, AirConditioning = true, Automatic = false, PricePerDay = 10000, Active = true },
            new VehicleModel(){ Id = 20, VehicleType = "Ford Tourneo Custom Titanium", VehicleUrl = "ford-tourneo-custom-5.png" ,NumberOfDoors = 5, NumberOfSeats = 8, AirConditioning = true, Automatic = false, PricePerDay = 10000, Active = true }
        ...
        public SeedService()
        {
            ...
            {
                new Address{ Id = 1, ZipCode = 1120, City = "Budapest", StreetAddress = "Kacsa utca 23", IsDeleted = false },
                new Address{ Id = 2, ZipCode = 1125, City = "Budapest", StreetAddress = "Fenyves utca 25", IsDeleted = false },
                new Address{ Id = 3, ZipCode = 1135, City = "Budapest", StreetAddress = "Lomb utca 23", IsDeleted = false },
                new Address{ Id = 4, ZipCode = 1122, City = "Budapest", StreetAddress = "Galamb utca 25", IsDeleted = false },
                new Address{ Id = 5, ZipCode = 1134, City = "Budapest", StreetAddress = "Szarvas út 15", IsDeleted = false },
            };
